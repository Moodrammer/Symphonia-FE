<template>
    ...
    <v-menu offset-y>
        ...
        <v-list max-height="600" width="500" dark dense tile avatar="true" three-line class="overflow-y-auto tileStyle">
            ...
            <v-list-item v-for="(notification,index) in notifications" :key="index"> 
                ...
                <v-list-item-content>
                    ...
                    <v-list-item-subtitle v-html="notification.body">test user started to follow you</v-list-item-subtitle>
                </v-list-item-content>
            </v-list-item>
        </v-list>
        </v-menu>        
