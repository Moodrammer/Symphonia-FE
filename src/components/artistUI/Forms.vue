        ...
        <v-card-text>
          <v-container>
            ...
            <v-row><v-divider></v-divider></v-row>
              ...
              <v-row>
                <v-col>
                  <v-switch v-model="explicit[i-1]" label="Explicit"></v-switch>
                </v-col>
                <v-col>
                  <v-switch v-model="premium[i-1]" label="Premium"></v-switch>
                </v-col>
              </v-row>
...
export default {
  ...
  mixins: [getuserToken],
  watch: {
    explicit:function(newValue){console.log(newValue)},
    uploading: function(){
      this.uploadedFiles = []
    },
