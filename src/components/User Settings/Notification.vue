              ...
              <tr class="form-group">
                <td>
                  ...
                  <p v-if="getuserType() == 'user'" class="description">
                    Push Notifications are sent on multiple events either. An Artist you follow adds a new track or album, or 
                    a user follows one of your amazing playlists
                  </p>
                  <p v-if="getuserType() == 'artist'" class="description">
                    Push Notifications are sent on multiple events either. An Artist you follow adds a new track or album, 
                    a user follows one of your amazing playlists, or a user starts to follow your artist account
                  </p>                  
                </td>
                <td>
                  <div>
  ...
  computed: {
    IsPushNotificationsAllowed: {
        ...
        set: function(newValue){
          ...
          this.$store.commit("notification/setPushNotificationsPermission", newValue)
        }
      }
  },
  components: {
