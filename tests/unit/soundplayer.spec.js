      ...
      modules: {
        track: {
          ...
          mutations: {
            ...
            setTotalDuration: (state, totalDuration) => {state.totalDuration = totalDuration}
          }
        },
        playlist: {
          namespaced: true,
          ...
          mutations: {
            ...
            setIsSongLoaded: (state, loaded) => {state.loaded = loaded},
            setIsFirstSong: (state, isFirstSong) => {state.isFirstSong = isFirstSong}
          },
          getters: {
            audio: (state) => {
              return state.audio;
